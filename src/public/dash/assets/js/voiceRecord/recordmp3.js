(function(global) {
  ...
  var initWorker = function() {
    WORKER_PATH = WORKER_PATH || MAIN_LINK+'/dash/assets/js/voiceRecord/recorderWorker.js';
    try {
      encoderWorker = encoderWorker || new Worker(MAIN_LINK+'/dash/assets/js/voiceRecord/recorderWorker.js');
    } catch (e) {
