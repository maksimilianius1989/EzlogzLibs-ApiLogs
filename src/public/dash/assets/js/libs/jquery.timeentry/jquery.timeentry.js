...
(function($) { // Hide scope, no $ conflict
 ...
 $(selector).timeEntry('setTime', null) */
		...
		_getSpinnerRegion: function(inst, event) {
			...
			//var scrolled = [document.documentElement.scrollLeft || document.body.scrollLeft, document.documentElement.scrollTop || document.body.scrollTop];  
			//ezlogz fix
			var scrolled = [document.documentElement.scrollLeft, document.documentElement.scrollTop ];
